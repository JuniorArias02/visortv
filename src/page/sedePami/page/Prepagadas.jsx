...
function Prepagadas() {
	...
	return (
		<div ref={containerRef} className="relative flex items-center justify-center h-screen bg-white overflow-hidden group">
			...
			<iframe
				src="https://docs.google.com/presentation/d/e/2PACX-1vSAaKv1BlNjqgive8sRKX8wAXZLsWreZTSYyWf2Xs7B-izLxrZ6t-7n8uydomtq-nkN4MR2AGE6nfHb/pubembed?start=true&loop=true&delayms=30000"
				frameBorder="0"
				width="1440"
				height="839"
